...
from acme.agents.jax.ddpg import learning
...
class DDPG(agent.Agent):
  ...
  def __init__(self,
    ...
    #emb_spec = jax_utils.create_variables(observation_network, [obs_spec])  # pytype: disable=wrong-arg-types

    behavior_network = hk.Sequential([
        observation_network,
        policy_network,
    ...
    # Create optimizers.
    policy_optimizer = optix.adam(learning_rate=1e-4)
    critic_optimizer = optix.adam(learning_rate=1e-4)
